...
>>>>>>> Stashed changes:E-Commerce-Website/src/pages/Account.jsx
      ...
      <div>
        <div className="flex w-full gap-10 pb-11 ">
          <div className="flex w-full flex-col basis-1/4 gap-3	">
          ...
          <button className="w-2/5 h-[56px] bg-red-500 rounded text-white text-[16px] font-medium">Save Change</button>
