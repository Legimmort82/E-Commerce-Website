...
const ProductDetails = () => {
  return (
    <div className="w-[1170px] my-0 mx-auto">
      ...
      <div className="flex flex-end gap-[70px]">
      ...
      <div className="w-[399px]">
        <h1 className="text-[24px] font-semibold	mb-[16px]">Havic HV G-92 Gamepad</h1>
        <Rout3>
          <Pic image={pic6} />
          <Pic image={pic6} />
          <Pic image={pic6} />
        ...
        <div className="flex mb-[24px]">
          <label className="text-[20px] font-normal leading-[20px] h-[20px]">Color:</label>
        ...
        <div className="flex items-start mb-[24px]">
          <label className="text-[20px] font-normal leading-[20px] mr-[24px]">Size :</label>
